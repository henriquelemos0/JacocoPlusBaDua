...
/**
 * Unit tests for {@link AbstractRuntimeData}.
 * 
 */
public class RuntimeDataTest {
	...
	public void testGenerateArgumentArray() throws Exception {
		...
		mv.visitCode();
		AbstractRuntimeData.generateArgumentArray(1000, "Sample", 15, mv);
	...
	public void testGenerateAccessCall() throws Exception {
		...
		mv.visitFieldInsn(Opcodes.GETFIELD, "Sample", "access",
				"Ljava/lang/Object;");
		AbstractRuntimeData.generateAccessCall(1234, "Sample", 5, mv);
		mv.visitInsn(Opcodes.ARETURN);
		mv.visitMaxs(6, 1);
		mv.visitEnd();
