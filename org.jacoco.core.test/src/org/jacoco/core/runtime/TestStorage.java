...
class TestStorage implements IExecutionDataVisitor, ISessionInfoVisitor {
	...
	private final Map<Long, IExecutionData> data = new HashMap<Long, IExecutionData>();
	...
	public IExecutionData getData(long classId) {
	...
	public void visitClassExecution(final IExecutionData ed) {
