 ...
 * counters.
 */
public interface ICoverageDua {

	/**
	 * Type of a Java element represented by a {@link ICoverageDua} instance.
	 */
	 ...
	 */
	public abstract ICounter getDuaCounter();
	...
	/**
	 * Creates a plain copy of this node. While {@link ICoverageDua}
